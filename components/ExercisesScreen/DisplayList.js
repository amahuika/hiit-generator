...
function DisplayList({ name, description, onDelete, onEdit, id }) {
  ...
  return (
    <Card>
      <RowSpaceBetween
        style={{ borderBottomColor: "#393E46", borderBottomWidth: 0.5 }}
      >
        <View>
          ...
          <Pressable onPress={onShowDetails}>
            <Text style={{ fontSize: 14 }}>
              ...
              {!showDescription ? (
                ...
                <Ionicons name="chevron-up" size={14} color="black" />
              )}
            </Text>
          </Pressable>
        </View>
        <RowSpaceBetween>
          <Pressable onPress={() => onEdit(id)}>
            <Ionicons name="create-outline" size={26} color="#454de3" />
          </Pressable>
          <View style={{ width: 20 }} />
          <Pressable
            onPress={() => {
          ...
          >
            <Ionicons name="trash-outline" size={26} color="#f31313" />
          </Pressable>
        </RowSpaceBetween>
      </RowSpaceBetween>
